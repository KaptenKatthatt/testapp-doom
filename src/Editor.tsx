...
type CellType = 'empty' | 'wall' | 'door' | 'player' | 'imp' | 'demon' | 'zombieman' | 'health' | 'ammo' | 'shotgun' | 'barrel' | 'lava' | 'slime';
...
export default function Editor() {
  ...
  const exportLevel = () => {
    ...
    for (const w of levelData.walls) {
      const colorHex = w.isDoor ? '0xcc0000' : '0x8b7355';
      code += `  { x: ${w.x}, y: 2, z: ${w.z}, w: ${w.w}, h: 4, d: ${w.d}, color: ${colorHex} },\n`;
    }
    code += `];\n\n`;
